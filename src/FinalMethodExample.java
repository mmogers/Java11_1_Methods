...
abstract class WillHaveManySubTypes {
    ...
    public abstract String toString(); // need to implement it in main method
...
public class FinalMethodExample extends WillHaveManySubTypes {
   ...
   /* public void doZOnlyOneWay() { //cannot override the final method
   ...
   /* public String toString() {
        return super.toString(); //parent  -abstract method cannot be accessed directly
    }*/
