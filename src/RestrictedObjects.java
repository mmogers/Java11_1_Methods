...
public class RestrictedObjects {
    public static void main(String[] args) {
        ...
        //OnlyClass o = new OnlyClass(); //'OnlyClass()' has private access in 'OnlyClass'
    }
}

/*
classmyOnlyClass extends OnlyClass { // cannot extend a class with only private constructors
}*/
